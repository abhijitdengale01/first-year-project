...
TARGET_FOLDER_NAME = "Movie_Short"  # Updated folder name
DIRECT_FOLDER_MODE = True  # Set to True to process videos directly from the main folder instead of subfolders
SPREADSHEET_ID = '1H1P1Qg9fk9CFRVEfsx8Ye6D6Rc_jArcJEohD8KMKYSk'  # Updated spreadsheet ID
SHEET_NAME = 'Sheet1'
...
DEFAULT_YOUTUBE_CHANNEL = "Blastify"  # Default channel to use if none specified

# Telegram Bot configuration
TELEGRAM_BOT_TOKEN = "7709824511:AAFsZUbcFLit-PGQaFjQqBYAfLUH-wcJ9n8"
TELEGRAM_CHAT_ID = "-1002493560505"
TELEGRAM_THREAD_ID = 2363
...
def get_google_drive_credentials():
    ...
    CREDENTIALS_DRIVE_LINK = "https://drive.google.com/file/d/1aRznP_OQuxhlrkKR4ihJLoghB0GnnIc7/view?usp=sharing"
...
def process_folder_for_upload(folder_data, row_index, channel_id=None, channel_name=None):
    ...
    if channel_name in ["Blastify", "BrawlEdge", "CineCombat", "ClashZone", "HitVerse"]:
        # These channels use first token group
        if channel_name == "Blastify":
            token_folder = "tokens_game_channel_1"
        elif channel_name == "BrawlEdge":
            token_folder = "tokens_game_channel_2"
        elif channel_name == "CineCombat":
            token_folder = "tokens_game_channel_3"
        elif channel_name == "ClashZone":
            token_folder = "tokens_game_channel_4"
        elif channel_name == "HitVerse":
            token_folder = "tokens_game_channel_5"
    # Group 2: Second five channels
    elif channel_name in ["Impactory", "PunchFrame", "RageCut", "SmashShot", "StrikeCore"]:
        # These channels use second token group
        if channel_name == "Impactory":
            token_folder = "tokens_game_channel_6"
        elif channel_name == "PunchFrame":
            token_folder = "tokens_game_channel_7"
        elif channel_name == "RageCut":
            token_folder = "tokens_game_channel_8"
        elif channel_name == "SmashShot":
            token_folder = "tokens_game_channel_9"
        elif channel_name == "StrikeCore":
            token_folder = "tokens_game_channel_10"
